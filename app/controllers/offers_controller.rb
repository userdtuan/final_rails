class OffersController < ApplicationController
  ...
  def new
    @offer = Offer.new
    @offer.post_id = params[:post_id]
    post = Post.where(id:@offer.post_id)
    @offer.seller_id = post.first.receiver_id
  end
  ...
  private
    ...
    def offer_params
      params.require(:offer).permit(:post_id, :status, :seller_id)
    end
